...
type BlabEdocDistDownloadCertRequest struct {
	...
	CertFilename string `json:"certFilename" url:"certFilename" example:"2021-1214-1323-0359-f1b9399d-4762-43fb-b97f-c6c28ce7e1ea.pdf" maxLength:"60" validate:"required"`
}
