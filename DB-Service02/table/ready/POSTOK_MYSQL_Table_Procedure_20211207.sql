...
--
-- Host: 211.253.86.102    Database: EMAILBOX
-- ------------------------------------------------------
...
CREATE TABLE `TBL_DOCUMENTS` (
  ...
  `dn_yn` varchar(2) DEFAULT 'Y' COMMENT '다운로드 가능 여부 확인',
  `edoc_no` varchar(33) DEFAULT NULL COMMENT '공인전자문서중계자 전자문서번호 [날짜](8)_[중계자플랫폼內 관리코드](10)_[일련번호](13)',
...
--
-- Table structure for table `TBL_EDOCUMENTS_SERIAL_NO`
--

DROP TABLE IF EXISTS `TBL_EDOCUMENTS_SERIAL_NO`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `TBL_EDOCUMENTS_SERIAL_NO` (
  `idx` bigint(20) NOT NULL AUTO_INCREMENT,
  `group_by` varchar(32) NOT NULL DEFAULT '' COMMENT '그룹으로 검색을 하기 위한 기관에서 관리하는 keyword ',
  ...
  `use_status` int(2) DEFAULT 1,
  `reg_dt` datetime NOT NULL COMMENT '등록 시간',
  PRIMARY KEY (`idx`),
  UNIQUE KEY `group_by` (`group_by`)
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `SP_AN_REG_DOCUMENT_V2` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`embuser`@`%` PROCEDURE `SP_AN_REG_DOCUMENT_V2`(
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`embuser`@`%` PROCEDURE `SP_IF_SET_MYDOCUMENT`(IN $PARAM_PCODE_IDX bigint, IN $PARAM_PCODE varchar(128),
